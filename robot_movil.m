% Simulación del movimiento de un robot en forma de cubo con velocidades 
% linear y angular ajustables

clear all
ts=0.01; 
t=0:ts:100; % vector tiempo (cantidad de pasos)

u=0.5*ones(1,length(t));    % velocidad lineal
w=0.04*ones(1,length(t));   % velocidad angular

% agregar aceleración lineal y angular:
